...
export default function Workshop() {
  ...
  const fissureImages = [
    { label: "12", url: "/src/assets/repair-places/12.png" },
    { label: "1:5", url: "/src/assets/repair-places/1:5.png" },
    { label: "3", url: "/src/assets/repair-places/3.png" },
    { label: "4:5", url: "/src/assets/repair-places/4:5.png" },
    { label: "6", url: "/src/assets/repair-places/6.png" },
    { label: "7:5", url: "/src/assets/repair-places/7:5.png" },
    { label: "9", url: "/src/assets/repair-places/9.png" },
    { label: "10:5", url: "/src/assets/repair-places/10:5.png" },
    { label: "left-heart", url: "/src/assets/repair-places/left-heart.png" },
    { label: "right-heart", url: "/src/assets/repair-places/right-heart.png" },
    { label: "core-heart", url: "/src/assets/repair-places/core-heart.png" },
  ];
